...
echo (Una volta premuto un qualsiasi tasto tornerai al men— iniziale)
pause
del /q C:\ProgrammazioneTimeAssistant\processi.txt
goto inizio
...
:informazioni
mode con: cols=84 lines=18
title Programmazione Time Assistant © ~ Informazioni
cls
echo.
echo.
echo                INFORMAZIONI ~ Programmazione Time Assistant ©
echo.
echo [ Questo assistente Š stato creato da Programmazione Time. ]
echo [ Versione assistente: 1.0.0 ]
echo.
echo ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
echo º                                                                                 º
...
echo º  [4] Controlla aggiornamento                                                    º
echo º                                                                                 º
echo ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
echo.
choice /c 01234 /n /m "Scegli una delle opzioni (per tornare indietro premi 0):"
if %errorlevel% == 1 goto inizio
if %errorlevel% == 2 start http://www.youtube.com/c/ProgrammazioneTime && goto inizio
if %errorlevel% == 3 start https://t.me/programmazionetime && goto inizio
if %errorlevel% == 4 start https://www.instagram.com/programmazionetime_official/ && goto inizio
if %errorlevel% == 5 start https://github.com/ProgrammazioneTime/ProgrammazioneTime_Assistant && goto inizio
